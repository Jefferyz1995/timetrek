  ...
  <div class="p-2">
      ...
      <div class="mb-[10px]" v-show="showSearch">
        <el-card shadow="hover">
          <el-form :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
            ...
            <el-form-item :label="$t('commonColumn.createTime')">
              <el-date-picker
    ...
    <el-card shadow="hover">
      ...
      >
        ...
        <el-table-column :label="$t('commonColumn.createTime')" align="center" prop="createTime" width="180" sortable="custom">
          <template #default="scope">
...
const handleDelete = async (row?: OssVO) => {
  ...
  await proxy?.$modal.confirm('是否确认删除OSS对象存储编号为"' + ossIds + '?');
  loading.value = true;
